...
from PregularMotor import Ui_form


class RegularMotorWindow(QtWidgets.QMainWindow, Ui_form):
    def __init__(self):
        super(RegularMotorWindow, self).__init__()
        self.setupUi(self)
    ...
    def updateLanguage(self):
        ...
        self.tittleGlow.setText("Regular Motor")#self.idioma.get("configTittle"))
        self.tittle.setText("Regular Motor")#self.idioma.get("configTittle"))
